<?php
  ...
  else
  {
    ...
    $greeting = "Thank you for shoping with us";
  }
    ...
    <h3 class="w3-wide"><font size="4"><strong>Danielle's Boutique</strong></font></h3>
        ...
        <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
          <p class="w3-bar-item"><font size="4">Shop By Category</p>
            <a href="jean.php" class="w3-bar-item w3-button">Jeans</a>
            <a href="shirt.php" class="w3-bar-item w3-button">Shirt</a>
          <a href="shoe.php" class="w3-bar-item w3-button">Shoe & Jeans </a>
      </div>
</nav>
...
<?php
  $i = 0;
	$product_array = $db_handle->runQuery("SELECT * FROM clothes WHERE cloth_type = 'my-jean' OR cloth_type = 'FPS' OR cloth_type = 'jean' ORDER BY cloth_name");
  ...
  <div class="w3-row">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <font size="3"><input type="text" class="product-quantity" name="quantity" value="1" size="1" /><input type="submit" value="Add to Bag" class="w3-button w3-black w3-margin-top" />
        </form>          
  ...
  <div class="w3-container">
    <div class="w3-display-container">
      ...
      <img src="<?php echo $product_array[4]["image"]; ?>" style="width:100%">
        <input type="text" class="product-quantity" name="quantity" value="1" size="2" /><input type="submit" value="Add to Bag" class="w3-button w3-black w3-margin-top" />
        </form>          
