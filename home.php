  ...
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3 class="w3-wide"><font size="4"><strong>Danielle's Boutique</strong></font></h3>
      ...
      <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
        <p class="w3-bar-item"><font size="4"><strong>Shop By Category</strong></p>
...
<div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
  ...
  <center><p><b><strong>DUE TO COVID-19, OUR STORES ARE TEMPORARILY CLOSED.</strong></b></p></center>
    <img src="product-images/header1.jpg" alt="Apex" style="width:100%"> </img>
    <center><p><b><strong>Danielle's Boutique SALE ! LIMITED TIME</strong></b></p></center>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <img src="<?php echo $product_array[0]["image"]; ?>" style="width:100%">
          <font size="3"><class="product-quantity" /><class="w3-button w3-black w3-margin-top"/>
          </form>          
...
<div class="w3-black w3-center w3-padding-24">Huy, Si, James</a>
</div>>
