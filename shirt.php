...
<header class="w3-bar w3-top w3-hide-large w3-black w3-xlarge">
  <div class="w3-top">
    <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
      <?php echo $wishlist ?>
    <?php echo $user ?>
  <a href="cart.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Shopping Bag</a>
  </div>
</div>
...
<div class="w3-container w3-text-grey" id="jeans">
  ...
  <?php
  $i = 0;
	$product_array = $db_handle->runQuery("SELECT * FROM clothes WHERE cloth_type = 'shirsts'");
...
<div class="w3-col l3 s6">
  <div class="w3-container">
    <form method="post" action="home.php?action=add&cloth_ID=<?php echo $product_array[2]["cloth_ID"]; ?>">
      ...
      <div class="w3-container">
  <div class="w3-display-container">
<form method="post" action="home.php?action=add&game_ID=<?php echo $product_array[6]["cloth_ID"]; ?>">
